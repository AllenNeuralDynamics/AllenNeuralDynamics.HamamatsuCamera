...
namespace HamamatsuCamera.API
{
    ...
    /// <summary>
    /// Heler class for DCAM
    /// </summary>
    public class DCAM_MANAGER
    {
        ...
        // function to get property value without DCAM_PROP_MANAGER
    ...
    /// <summary>
    /// helper class for DCAMWAIT and dcamwait functions
    /// </summary>
    class DCAM_WAIT_MANAGER : IDisposable
    {
        public DCAMERR m_lasterr;
        ...
        public DCAM_WAIT_MANAGER( ref DCAM_MANAGER hdcam_manager )
        {
            if( hdcam_manager.m_hdcam == IntPtr.Zero )
            {
                // hdcam_manager should have valid DCAM handle.
                m_lasterr = DCAMERR.INVALIDHANDLE;
                m_hwait = IntPtr.Zero;
            }
            else
            {
                ...
                param.hdcam = hdcam_manager.m_hdcam;
    ...
    /// <summary>
    /// helper class for DCAMREC and dcamrec functions
    /// </summary>
    class DCAM_REC_MANAGER
    {
    ...
    /// </summary>
    public class DCAM_PROP_MANAGER
    {
        public DCAMERR m_lasterr;
        public IntPtr m_hdcam;
        ...
        public DCAM_PROP_MANAGER(DCAM_MANAGER hdcam_manager, DCAMIDPROP _iprop)
        {
            m_hdcam = hdcam_manager.m_hdcam;
            m_idProp = _iprop;
            m_attr = new DCAMPROP_ATTR(m_idProp);
        }
        public DCAM_PROP_MANAGER(IntPtr hdcam, DCAMIDPROP _iprop)
        {
            m_hdcam = hdcam;
            m_idProp = _iprop;
            m_attr = new DCAMPROP_ATTR(m_idProp);
        }
        public DCAM_PROP_MANAGER Clone()
        {
            DCAM_PROP_MANAGER ret = new DCAM_PROP_MANAGER(m_hdcam,m_idProp);
            ret.m_attr = m_attr;
            return ret;
        }
