...
namespace AllenNeuralDynamics.HamamatsuCamera.Calibration
{
    ...
    class C13440Editor : WorkflowComponentEditor
    {
        ...
        /// <see cref="CalibrationForm"/>
        /// </summary>
        /// <param name="context">Unused in this Override function</param>
        /// <param name="component"><see cref="C13440"/> instance.</param>
        /// <param name="provider">Service provider</param>
        /// <param name="owner">Window that contains the modal dialog used to display the <see cref="CalibrationForm"/></param>
        /// <returns></returns>
        public override bool EditComponent(ITypeDescriptorContext context, object component, IServiceProvider provider, IWin32Window owner)
        {
            ...
            if (provider != null)
            {
                ...
                if (editorState != null)
                {
                    ...
                    var acquiring = capture.Capture.Acquiring;
                    var bundling = capture.EnableBundling;
                    capture.EnableBundling = false;
                    capture.Capture.Acquiring = true;
                    capture.Capture.IsConfigMode = true;
                    using (var editorForm = new CalibrationForm(capture))
                    {
                        try
                        {
                    ...
                    capture.EnableBundling = bundling;
                    capture.Capture.Acquiring = acquiring;
                    capture.Capture.IsConfigMode = false;
                }
            }
